...
Insert the given records into the Hospital Management System database tables and retrieve the first record from the **Doctors**, **Patients**, and **Appointments** tables.

## Problem Statement

Perform the following tasks using SQL:

1. Insert the given records into the database tables exactly as specified.
2. Retrieve the first record from the following tables:
   - Doctors
   - Patients
   - Appointments
...
The complete SQL script is available in [`answer.sql`](answer.sql).
...
All records were inserted successfully into the specified Hospital Management System tables. The first record from **Doctors**, **Patients**, and **Appointments** was retrieved successfully.
